...
class FLDT_NoButton extends ET_Builder_Module
{
	...
	function init()
	{
		$this->name             = et_builder_i18n('Upsell/Downsell No Button');
		$this->plural           = esc_html__('Upsell/Downsell No Buttons', 'fluxtore-divi-buttons');
		$this->slug             = 'fldt_no_button';
		$this->vb_support       = 'on';
	...
	public function render($attrs, $content = null, $render_slug)
	{
		...
		$output = sprintf(
			'<div class="et_pb_button_module_wrapper fluxtore_no_button %3$s_wrapper %2$s et_pb_module "%4$s style="text-align:'.$button_alignment .';">
				%1$s
			</div>',
