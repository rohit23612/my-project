...
class Next_Step_Button extends Element {
	public $block    = 'core/button';
	public $category = 'woocommerce';
	public $name     = 'next_button';
	public $icon     = 'ti-control-stop';
	public $tag      = 'span';

	public function get_label() {
		return esc_html__( 'Fluxtore Next Step Button', 'bricks' );
	}

	public function set_controls() {
		$this->controls['text'] = [
			'type'        => 'text',
			'default'     => esc_html__( 'Fluxtore Next Step Button', 'bricks' ),
			'placeholder' => esc_html__( 'Fluxtore Next Step Button', 'bricks' ),
		];
	...
	public function render() {
      global $post;
		...
		if ( isset( $settings['block'] ) ) {
		 ...
		 $settings['link'] = array("type" => "external", "url" => $next_step_url);
	...
	public static function render_builder() { ?>
		<script type="text/x-template" id="tmpl-bricks-next-button">
			<component
