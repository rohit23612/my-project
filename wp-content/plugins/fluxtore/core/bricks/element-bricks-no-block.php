...
class Prefix_Element_No_Block extends \Bricks\Element {
  // Element properties
  ...
  public $name         = 'prefix-test-no'; // Make sure to prefix your elements 
  public $tag      = 'span';

  // Return localised element label
  public function get_label() {
    return esc_html__( 'Upsell/Downsell No Button Block', 'bricks' );
  }
  ...
  public function set_controls() {
    $this->controls['text'] = [
			'type'        => 'text',
			'default'     => esc_html__( 'No, I want to skip this offer', 'bricks' ),
			'placeholder' => esc_html__( 'No, I want to skip this offer', 'bricks' ),
		];
